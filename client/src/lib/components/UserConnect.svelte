<script lang="ts">
    ...
    let { title,view = $bindable(),username,password } = $props()
...
<form id="setConnect" method="POST" action="?/login">
    <input type="text" placeholder="Username" name="username" bind:value={username} bind:this={input} />
